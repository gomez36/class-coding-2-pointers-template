...
namespace example2 {
    void example() {
        ...
        cout << "Address stored in ip variable: "<<anything<<endl;

        //TODO 2// access the value at the address available in pointer
        cout << "Value of *ip variable: "<<*anything<<endl;

        //TODO 2
        cout << "Address of *ip variable: "<<&anything<<endl;

        //TODO 2 - set the pointer to null pointer
        *anything = NULL;
        cout << "The value of ptr is "<<*anything<<endl;
    }
}
